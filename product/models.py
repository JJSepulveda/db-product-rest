...
class Producto(models.Model):
    ...
    existencia = models.PositiveIntegerField(blank=True, null=True, default=0)
    existenciaPiso = models.PositiveIntegerField(blank=True, null=True, default=0)
    existenciaProd = models.PositiveIntegerField(blank=True, null=True, default=0)
    existenciaTubos = models.PositiveIntegerField(blank=True, null=True, default=0)
    existenciaTanques = models.PositiveIntegerField(blank=True, null=True, default=0)
    existenciaDistr = models.PositiveIntegerField(blank=True, null=True, default=0)
    existenciaMakita = models.PositiveIntegerField(blank=True, null=True, default=0)
    existenciaStaRosa = models.PositiveIntegerField(blank=True, null=True, default=0)
    existenciaTotal = models.PositiveIntegerField(blank=True, null=True, default=0)
