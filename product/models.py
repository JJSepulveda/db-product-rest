...
class Producto(models.Model):
    ...
    codigosAlternos = models.CharField(max_length=100, blank=True, null=True)
    activo = models.CharField(max_length=10, blank=True, null=True)
    prov = models.IntegerField(blank=True, null=True)
    ...
    nomCodSat = models.CharField(max_length=100, blank=True, null=True)
